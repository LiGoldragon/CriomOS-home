{
  ...
  inputs = {
    ...
    claude-code-vsix = {
      type = "file";
      url = "https://open-vsx.org/api/Anthropic/claude-code/linux-x64/2.1.161/file/Anthropic.claude-code-2.1.161@linux-x64.vsix";
      flake = false;
    };
    ...
    persona-spirit-v0-5-2.url = "github:LiGoldragon/persona-spirit?rev=5227741e6a220e82ea000db6eb1d3a1466571fcc";
    ...
    pi-src = {
      url = "github:earendil-works/pi?ref=v0.78.0";
      flake = false;
    };
