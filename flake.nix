{
  ...
  inputs = {
    ...
    claude-code-vsix = {
      type = "file";
      url = "https://open-vsx.org/api/Anthropic/claude-code/linux-x64/2.1.206/file/Anthropic.claude-code-2.1.206@linux-x64.vsix";
      flake = false;
    };
    ...
    pi-src = {
      url = "github:earendil-works/pi?ref=v0.80.6";
      flake = false;
    };
    ...
    pi-subagents-src = {
      url = "github:LiGoldragon/pi-subagents-nicobailon/921a8878044d1ff478228e0cf495857b2285fcb3";
      flake = false;
    };
    pi-intercom-src = {
