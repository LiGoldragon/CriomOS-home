{
  ...
  inputs = {
    ...
    claude-code-vsix = {
      type = "file";
      url = "https://marketplace.visualstudio.com/_apis/public/gallery/publishers/anthropic/vsextensions/claude-code/2.1.251/vspackage";
      flake = false;
    };
    ...
    wispr-flow-linux.url = "github:LiGoldragon/wispr-flow-linux?rev=209401680034668a680b5632fba42daeef93667a";
