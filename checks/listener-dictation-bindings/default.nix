...
let
  ...
  assertions = [
    ...
    {
      condition = lib.versionAtLeast (listenerPackage.version or "0") "0.14.0";
      message = "Listener package must be version 0.14.0 or newer (records during parallel transcription)";
    }
    {
