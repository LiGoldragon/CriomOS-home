...
let
  ...
  claude-code-codium = pkgs.vscode-utils.buildVscodeMarketplaceExtension {
    ...
    vsix = vsixFromInput "claude-code-2.1.250.vsix" inputs.claude-code-vsix;
    postInstall = ''
  ...
  codex-chatgpt-codium = pkgs.vscode-utils.buildVscodeMarketplaceExtension {
    mktplcRef = {
      name = "chatgpt";
      publisher = "openai";
      version = "26.5825.32147";
    };
    vsix = vsixFromInput "openai.chatgpt-26.5825.32147-linux-x64.vsix" inputs.codex-chatgpt-vsix;
  };
